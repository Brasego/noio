      ...
      items: [
        {
          ...
          description:
            'Jej :"Jej, plus communément appelé « jej humain », « humain », ou « être humain », appartient à la famille des hominidés toulousains. L’animal de petite taille se manifeste par une production graphique employant diverses techniques de gravures dont notamment la technique du monotype, procédé dimpression qui produit un tirage unique.',
          id: 1,
          linkUrl: "blog",
          isUp: true,
        },
        ...
        },
        {
          ...
          imageUrl: "https://i.ibb.co/cyJHcMz/Canelle.jpg",
          description:
            "LESCOPAINS « est un collectif d’artistes réunissant Sønn, Fils Kurylak et Baron. Ce collectif toulousain s’est formé pour travailler ensemble dans le partage et l’approche de nouvelles expériences. »",
          id: 3,
          linkUrl: "blog",
          isUp: true,
        },
      ...
      <div className="blog-display">
        {
          ...
          this.state.items.length && this.sliceItems(this.state.items).length
            ? this.sliceItems(this.state.items).map((section, index) => {
                return (
